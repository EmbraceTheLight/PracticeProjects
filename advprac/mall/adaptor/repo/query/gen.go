...
func SetDefault(db *gorm.DB, opts ...gen.DOOption) {
	*Q = *Use(db, opts...)
	...
	AppUser = &Q.AppUser
	CourseCatalog = &Q.CourseCatalog
	CourseGood = &Q.CourseGood
	CourseLesson = &Q.CourseLesson
	MobileUser = &Q.MobileUser
	Order = &Q.Order
	OrderItem = &Q.OrderItem
	Permission = &Q.Permission
	ResourceUploadFile = &Q.ResourceUploadFile
	Role = &Q.Role
	RolePermission = &Q.RolePermission
	SmsTemplate = &Q.SmsTemplate
	User = &Q.User
	UserCourseGood = &Q.UserCourseGood
...
type queryCtx struct {
	...
	AppUser            IAppUserDo
	CourseCatalog      ICourseCatalogDo
	CourseGood         ICourseGoodDo
	CourseLesson       ICourseLessonDo
	MobileUser         IMobileUserDo
	Order              IOrderDo
	OrderItem          IOrderItemDo
	Permission         IPermissionDo
	ResourceUploadFile IResourceUploadFileDo
	Role               IRoleDo
	RolePermission     IRolePermissionDo
	SmsTemplate        ISmsTemplateDo
	User               IUserDo
	UserCourseGood     IUserCourseGoodDo
	WechatUser         IWechatUserDo
}
