...
func newOrder(db *gorm.DB, opts ...gen.DOOption) order {
	...
	_order.OrderSource = field.NewInt64(tableName, "order_source")
	...
	_order.ReceiverConfirmType = field.NewInt64(tableName, "receiver_confirm_type")
	...
	_order.CancelType = field.NewInt64(tableName, "cancel_type")
	...
	_order.TransferAt = field.NewInt64(tableName, "transfer_at")
	_order.TransferBy = field.NewInt64(tableName, "transfer_by")
...
type order struct {
	...
	Status              field.Int64  // -1：已取消,1：待付 2：已付（待发货）
	OrderSource         field.Int64  // 1：户下单 2：管理后台 3：系统赠送
	OrderAmount         field.Int64  // 订单金额=支付金额,单位:分
...
func (o *order) updateTableName(table string) *order {
	...
	o.OrderSource = field.NewInt64(table, "order_source")
	...
	o.ReceiverConfirmType = field.NewInt64(table, "receiver_confirm_type")
	...
	o.CancelType = field.NewInt64(table, "cancel_type")
	...
	o.TransferAt = field.NewInt64(table, "transfer_at")
	o.TransferBy = field.NewInt64(table, "transfer_by")
...
func (o *order) fillFieldMap() {
	o.fieldMap = make(map[string]field.Expr, 25)
	o.fieldMap["id"] = o.ID
	...
	o.fieldMap["transfer_at"] = o.TransferAt
	o.fieldMap["transfer_by"] = o.TransferBy
}
