...
func newAppUser(db *gorm.DB, opts ...gen.DOOption) appUser {
	...
	_appUser.AppCode = field.NewInt64(tableName, "app_code")
	_appUser.OpenID = field.NewString(tableName, "open_id")
	_appUser.Status = field.NewInt64(tableName, "status")
...
type appUser struct {
	...
	AppCode  field.Int64  // 1000=公众号,1001=小程序, 其他进扩展,固定值不能变更
...
func (a *appUser) updateTableName(table string) *appUser {
	...
	a.AppCode = field.NewInt64(table, "app_code")
