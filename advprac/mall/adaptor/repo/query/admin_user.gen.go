...
func newAdminUser(db *gorm.DB, opts ...gen.DOOption) adminUser {
	...
	_adminUser.Sex = field.NewInt64(tableName, "sex")
	_adminUser.IsDelete = field.NewInt64(tableName, "is_delete")
...
type adminUser struct {
	...
	ALL        field.Asterisk
	ID         field.Int64  // 主键-管理员 id 表
	Name       field.String // 名字
	NickName   field.String // 昵称
	Mobile     field.String // 手机号码
	LarkOpenID field.String // 用于飞书扫码登录
	Password   field.String // 密码
	Status     field.Int64  // 1:正常   -1: 禁用
	CreateAt   field.Time
	UpdateAt   field.Time
	CreateBy   field.Int64
	UpdateBy   field.Int64
	Sex        field.Int64 // 性别   3: 其他  1: 男  2: 女
